...
// 移动端菜单处理
const menuButton = document.querySelector('.all-information');
const menuContent = document.querySelector('.top-information');
const closeButton = document.querySelector('.top-information .close-button');
...
if (menuButton && menuContent) {
    ...
    // 点击菜单项时关闭菜单
    const menuItems = menuContent.querySelectorAll('.information');
